...
WHERE	A.D_E_L_E_T_=''
		AND A.D1_EMISSAO BETWEEN '20200101' AND '20200131'
		AND A.D1_TIPO='D'
...
SELECT D2_CUSTO1,(B.D1_CUSTO/D1_QUANT)*D2_QUANT,D1_CUSTO,D2_QUANT,D1_QUANT,*
--UPDATE A SET A.D2_CUSTO1=(B.D1_CUSTO/D1_QUANT)*D2_QUANT
FROM SD2010 A
INNER JOIN SD1010 B ON B.D_E_L_E_T_='' AND B.D1_FILIAL=A.D2_FILIAL AND B.D1_DOC=A.D2_NFORI AND B.D1_SERIE=A.D2_SERIORI AND B.D1_ITEM=A.D2_ITEMORI
WHERE	A.D_E_L_E_T_=''
		AND A.D2_EMISSAO BETWEEN '20200101' AND '20200131'
		AND A.D2_TIPO='D'
