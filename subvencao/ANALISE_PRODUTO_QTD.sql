...
SELECT B9_COD, SUM(INICIAL) INICIAL, SUM(SD1) SD1, SUM(SD2) SD2, SUM(SD3E) SD3E, SUM(SD3S) SD3S, SUM(FINAL) FINAL,SUM(INICIAL+SD1+SD3E-SD2-SD3S) MOV,SUM(INICIAL+SD1+SD3E-SD2-SD3S-FINAL) DIF
FROM
